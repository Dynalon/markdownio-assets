    ...
    var methods = {
	  	twitterfollow: function (opt) {
            ...
            return $this.each(function() {
				...
				var twitter_src = $('<a href="' + href + '" class="twitter-follow-button" data-show-count="false"'
					+ ' data-lang="en" data-show-screen-name="false">"'+ '@' + user + '</a>'
